...
function Hero() {
  return (
    ...
    <div className="w-w-full container mx-auto pt-12 pb-24 text-center">
      ...
      <Typography variant="lead" className="mx-auto mt-8 mb-4 w-full px-8 !text-gray-700 lg:w-10/12 lg:px-12 xl:w-8/12 xl:px-20 text-justify" >
        ...
        <Typography variant="small" className="font-normal text-gray-700">
          kontak{" "}
            <a
              ...
              className="hover:text-gray-900 transition-colors underline"
            >
              Umpan balik, pertanyaan, dan saran selalu diterima
            </a>
          </Typography>
      </div>
    </div>
